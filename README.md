...
| ✅  | [no-unnecessary-actionability-check](./docs/rules/no-unnecessary-actionability-check.md)  | Disallow redundant should() checks before actions which are implicitly checked |
